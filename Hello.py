...
import pandas as pd
from utils import load_data, filter_data, pivot_data, calculate_sector_data, calculate_metrics, generate_line_chart, generate_bar_chart, calculate_average_emissions
